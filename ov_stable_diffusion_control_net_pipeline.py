...
TEXT_ENCODER_OV_PATH = r"C:\Users\webnu\source\repos\StableDiffusion\sd-ov-tools\models\IrisMix-v5b-ov\text_encoder\openvino_model.xml"
UNET_OV_PATH = r"C:\Users\webnu\source\repos\StableDiffusion\sd-ov-tools\models\IrisMix-v5b-ov\unet\openvino_model.xml"
VAE_DECODER_OV_PATH = r"C:\Users\webnu\source\repos\StableDiffusion\sd-ov-tools\models\IrisMix-v5b-ov\vae_decoder\openvino_model.xml"
...
if len(LORA_PATH) == 0:
    ov_pipe = OVContrlNetStableDiffusionPipeline(tokenizer, 
                                                 scheduler, 
                                                 core, 
                                                 CONTROLNET_OV_PATH, 
                                                 ...
                                                 None, 
                                                 None, 
                                                 device="AUTO") #change to CPU or GPU
else:
